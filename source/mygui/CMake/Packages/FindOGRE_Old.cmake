...
# Then try everything else
	...
	ELSE (WIN32) #Unix
		IF (OGRE_SOURCE_DIR)
			...
			SET(OGRE_LIB_DIR ${OGRE_SOURCE_DIR}/lib)
		ELSE ()
			# Codebuff web port: prefer a prebuilt OGRE found in CMAKE_PREFIX_PATH
			# (pkg-config is unavailable in the Emscripten cross-compile environment).
			find_path(OGRE_INCLUDE_DIR OgrePrerequisites.h PATHS "${CMAKE_PREFIX_PATH}/include/OGRE" NO_DEFAULT_PATH)
			find_library(OGRE_MAIN_LIBRARY NAMES OgreMainStatic PATHS "${CMAKE_PREFIX_PATH}/lib" NO_DEFAULT_PATH)
			if (OGRE_INCLUDE_DIR AND OGRE_MAIN_LIBRARY)
				SET(OGRE_LIBRARIES OgreMainStatic)
				SET(OGRE_LIB_DIR "${CMAKE_PREFIX_PATH}/lib")
			else()
