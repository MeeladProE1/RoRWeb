...
// Codebuff web port: RoRnet.h is included unconditionally - several files rely
// on its types (e.g. PeerOptionsRequest, UiStreamsHealth) even when networking
// (USE_SOCKETW) is compiled out.
