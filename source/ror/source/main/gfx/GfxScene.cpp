...
#ifdef __EMSCRIPTEN__
    // Register the scene manager with RTSS (needed for lighting-aware generated shaders).
    if (Ogre::RTShader::ShaderGenerator::getSingletonPtr())
    {
        Ogre::RTShader::ShaderGenerator::getSingletonPtr()->addSceneManager(m_scene_manager);
    }
#endif
