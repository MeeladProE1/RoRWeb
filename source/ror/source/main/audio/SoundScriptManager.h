...
// Codebuff web port: no-audio build. These stubs keep the whole codebase
// compiling when OpenAL is disabled (sound is off in the browser build).
...
{
public:
    SoundPtr createSound(Ogre::String filename, Ogre::String resource_group_name = "") { return SoundPtr(); }
    void CleanUp() {}
    float GetSpeedOfSound() { return 343.0f; }
};
...
{
public:
    SoundScriptInstancePtr createInstance(Ogre::String templatename, int actor_id, int soundLinkType = SL_DEFAULT, int soundLinkItemId = -1) { return SoundScriptInstancePtr(); }
    void removeInstance(const SoundScriptInstancePtr&) {}
    std::vector<SoundScriptInstancePtr>& getAllInstances() { return instances; }
    SoundScriptTemplatePtr& getTemplate(Ogre::String name) { return templates[name]; }
    std::map<Ogre::String, SoundScriptTemplatePtr>& getAllTemplates() { return templates; }

    void trigOnce    (int, int, int = SL_DEFAULT, int = -1) {}
    void trigOnce    (const ActorPtr&, int, int = SL_DEFAULT, int = -1) {}
    void trigStart   (int, int, int = SL_DEFAULT, int = -1) {}
    void trigStart   (const ActorPtr&, int, int = SL_DEFAULT, int = -1) {}
    void trigStop    (int, int, int = SL_DEFAULT, int = -1) {}
    void trigStop    (const ActorPtr&, int, int = SL_DEFAULT, int = -1) {}
    void trigToggle  (int, int, int = SL_DEFAULT, int = -1) {}
    void trigToggle  (const ActorPtr&, int, int = SL_DEFAULT, int = -1) {}
    void trigKill    (int, int, int = SL_DEFAULT, int = -1) {}
    void trigKill    (const ActorPtr&, int, int = SL_DEFAULT, int = -1) {}
    bool getTrigState(int, int, int = SL_DEFAULT, int = -1) { return false; }
    bool getTrigState(const ActorPtr&, int, int = SL_DEFAULT, int = -1) { return false; }
    void modulate    (int, int, float, int = SL_DEFAULT, int = -1) {}
    void modulate    (const ActorPtr&, int, float, int = SL_DEFAULT, int = -1) {}

    void setEnabled(bool) {}

    void SetListener(Ogre::Vector3, Ogre::Vector3, Ogre::Vector3, Ogre::Vector3) {}
    void setLoadingBaseSounds(bool) {}
