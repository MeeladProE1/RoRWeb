...
foreach(_cmake_expected_target IN ITEMS OgreMain OgreGLSupport RenderSystem_GLES2 Plugin_OctreeSceneManager Codec_STBI Plugin_ParticleFX OgreBites OgrePaging OgreMeshLodGenerator OgreProperty OgreTerrain OgreRTShaderSystem OgreOverlay)
...
set_target_properties(OgreMain PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "C:/a1e/Tests/c1e/C2e/build/deps/lib/libzzip-0.a;\$<LINK_ONLY:ZLIB::ZLIB>"
)
...
set_target_properties(RenderSystem_GLES2 PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "OgreMain;OgreGLSupport"
)
...
set_target_properties(OgreBites PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "OgreMain;OgreOverlay;\$<LINK_ONLY:Plugin_OctreeSceneManager>;\$<LINK_ONLY:Plugin_ParticleFX>;\$<LINK_ONLY:Codec_STBI>;\$<LINK_ONLY:RenderSystem_GLES2>;OgreRTShaderSystem"
)
...
set_target_properties(OgreOverlay PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "OgreMain;C:/a1e/Tests/c1e/C2e/build/deps/lib/libfreetype.a;\$<LINK_ONLY:ZLIB::ZLIB>"
)
