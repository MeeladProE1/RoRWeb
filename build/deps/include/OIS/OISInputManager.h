...
namespace OIS
{
	...
	*/
	...
	public:
		...
		*/
		virtual int getNumberOfDevices(Type iType);
		...
		*/
		virtual DeviceList listFreeDevices();
		...
		*/
		virtual void destroyInputObject(Object* obj);
		...
		@notes
			...
			input manager.
		*/
		virtual void addFactoryCreator(FactoryCreator* factory);
		...
		*/
		virtual void removeFactoryCreator(FactoryCreator* factory);
		...
		*/
		virtual void enableAddOnFactory(AddOnFactories factory);
